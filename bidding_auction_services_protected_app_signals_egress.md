...
<img src="images/temporary-unlimited-egress-with-padding.png" width="80%" alt="Feature values in wire format">

Wire format of the feature values + padding + header would be:

<img src="images/temporary-unlimited-egress-payload.png" width="80%" alt="Feature values in wire format">

#### Wire format for <code>egressPayload</code>:</strong>

Wire format of the feature values + padding would be: 

<img src="images/egress-payload-with-padding.png" width="80%" alt="Feature values in wire format">

Wire format of the feature values + padding + header would be:

<img src="images/egress-payload.png" width="80%" alt="Feature values in wire format">
